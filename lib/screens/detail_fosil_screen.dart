...
import 'package:ashraf_skripsi/screens/ar_webview_fosil_screen.dart';
import 'package:flutter/material.dart';


class DetailFosilScreen extends StatelessWidget {
  final String? images;
  final String? desc;
  final String? link;
  const DetailFosilScreen({Key? key, this.images, this.desc, this.link}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Detail Fosil"),
        elevation: 0,
        centerTitle: true,
                ...
                child: new ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(new MaterialPageRoute(builder: (context){
                      return new ArWebViewFosilScreen(link: link,);
                    }));
                  },
